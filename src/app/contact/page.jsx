...
export const metadata = {
  title: "Contactanos",
  description:
    "Estamos aquí para ayudarte en todo lo que necesites. No dudes en contactarnos para cualquier consulta, duda o sugerencia que tengas. Nuestro equipo está siempre dispuesto a brindarte la mejor atención y resolver tus inquietudes de manera rápida y eficiente.",
};
