...
const processSteps = [
    {
        ...
        description: "Comenzamos con una evaluación exhaustiva de su sitio web y competidores, identificando las oportunidades y desafíos únicos de su negocio.",
        bgClass: "bg1",
    },
    {
        id: 2,
        ...
        description: "Nuestro equipo de expertos desarrollan una solución que se adapte a sus necesidades y objetivos comerciales.",
    ...
    },
    {
        ...
        description: "Después de una revisión exhaustiva y aprobación de su solución, la desplegamos para que pueda comenzar a ver los resultados.",
        bgClass: "bg3",
    }
];
        ...
        <section className="process-area pb-120">
            <div className="container">
                <div className="d-flex flex-wrap mb-80 justify-content-between align-items-end gap-3">
                    ...
                    <p>Nuestro proceso de trabajo comprobado combina experiencia, precisión e innovación para obtener resultados consistentemente sobresalientes.</p>
                </div>
